...
export default function AdminCustomizations() {
  ...
  async function handleToggleActivo(customization) {
    try {
      ...
      Swal.fire({
        title: '¡Actualizado!',
        text: `Personalización ${customization.activo ? 'desactivada' : 'activada'} correctamente`,
        icon: 'success',
        timer: 1500,
  ...
  async function handleSubmit(formData) {
    try {
      ...
      Swal.fire({
        title: '¡Guardado!',
        text: editingCustomization ? 'Personalización actualizada correctamente' : 'Personalización creada correctamente',
        icon: 'success',
        timer: 1500,
        showConfirmButton: false
      });
