      ...
      <div className="configuracion-content">
        <div className="config-section">
          ...
          <p style={{ fontSize: '0.85rem', color: 'var(--color-text-muted)', marginTop: -8, marginBottom: 12 }}>
            Información registrada desde el DeveloperPanel. Solo puede modificarse allí — aparece en el encabezado del ticket.
          </p>
        ...
        <div className="config-section">
          ...
          <div className="config-form">
            ...
            <div style={{border: '1px solid #ddd', borderRadius: 8, maxHeight: 200, overflowY: 'auto'}}>
              {cajas.map(caja => {
                const cajaId = caja._id || caja.id;
                return (
                  <div key={cajaId} style={{padding: '12px 15px', borderBottom: '1px solid #ddd'}}>
                    {caja.nombre}
                  </div>
                );
              })}
