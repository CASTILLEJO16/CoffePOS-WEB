...
export async function getSales(req, res) {
  try {
    ...
    // Enriquecer los datos con nombre de usuario
    const enrichedSales = sales.map(sale => ({
      ...sale.toObject ? sale.toObject() : sale,
      usuario_nombre: sale.usuario_id?.nombre || 'Desconocido'
    }));
...
/**
 * Devuelve una venta (requiere autorización con contraseña de admin)
 */
