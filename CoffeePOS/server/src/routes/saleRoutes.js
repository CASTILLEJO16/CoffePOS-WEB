...
router.post('/:id/devolver', requireSellerOrAdmin, saleController.refundSale); // Vendedores pueden devolver con contraseña de admin
router.post('/:id/cancelar', requireAdmin, saleController.cancelSale); // Solo admin puede cancelar
